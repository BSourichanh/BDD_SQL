...
public class AnalyticsController {
    ...
    public Map<String, Object> getAnalyticsData() {
        ...
        // Requêtes Spark SQL In-Memory sur le Dataset
        ...
        // Simulations structurées d'activités et créations
        response.put("top_10_activites", List.of(
        ...
        response.put("top_10_entreprises", List.of(
        ...
        response.put("time_series_creations", timeSeries);
